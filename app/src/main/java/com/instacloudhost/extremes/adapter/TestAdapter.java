...
public class TestAdapter extends RecyclerView.Adapter<TestAdapter.ViewHolder>{
    ...
    public TestAdapter(ArrayList<Message> mTestModel) {
    ...
    public TestAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.single_test_item,viewGroup,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            //cx_name10=(TextView) itemView.findViewById(R.id.txt_test10);
